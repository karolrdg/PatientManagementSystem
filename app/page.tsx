      ...
      <section className="remove-scroll-bar container my-auto">
        <div className="sub-container max-w-[496px]">
          ...
          <div className="text-14-regular mt-20 flex justify-between">
            ...
            <Link href="/?adm=true" className="text-green-500">Admin Login</Link>
          </div>
        </div>
      </section>

      <Image src="/assets/images/onboarding-img.png" height={1000} width={1000} alt="doctor" className="side-img max-w-[50%]"
      />
    </div>
  );
}
